...
class PricingRatelimitFeature extends PricingBaseFeature
{
    ...
    private function _acquire(PricingContext $ctx): void
    {
    ...
    private function _track(PricingContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
