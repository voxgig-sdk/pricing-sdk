...
class PricingFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; PricingSDK/1.0)';
    ...
    public static function call(PricingContext $ctx, string $fullurl, array $fetchdef): array
    {
