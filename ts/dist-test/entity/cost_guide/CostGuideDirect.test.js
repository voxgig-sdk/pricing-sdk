...
(0, node_test_1.describe)('CostGuideDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-cost_guide', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-cost_guide', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.PRICING_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    const calls = [];
    const env = (0, utility_1.envOverride)({
        'PRICING_TEST_COST_GUIDE_ENTID': {},
    ...
    if (live) {
        ...
        const client = new __1.PricingSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['PRICING_TEST_COST_GUIDE_ENTID'];
    ...
    const client = new __1.PricingSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=CostGuideDirect.test.js.map