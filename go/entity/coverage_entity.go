...
func NewCoverageEntity(client *core.PricingSDK, entopts map[string]any) *CoverageEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CoverageEntity) GetName() string { return e.name }
...
func (e *CoverageEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CoverageEntity) Deleted() bool {
	return e.deleted
}


func (e *CoverageEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCoverageEntity(e.client, opts)
}

func (e *CoverageEntity) Data(args ...any) any {
...
func (e *CoverageEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Coverage; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CoverageEntity) DataTyped(data ...Coverage) Coverage {
	if len(data) > 0 {
		return typedFrom[Coverage](e.Data(asMap(data[0])))
	}
	return typedFrom[Coverage](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Coverage (all fields
// optional at the wire level).
func (e *CoverageEntity) MatchTyped(match ...Coverage) Coverage {
	if len(match) > 0 {
		return typedFrom[Coverage](e.Match(asMap(match[0])))
	}
	return typedFrom[Coverage](e.Match())
}
...
func (e *CoverageEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CoverageEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CoverageLoadMatch and returns an Coverage. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CoverageEntity) LoadTyped(reqmatch CoverageLoadMatch, ctrl map[string]any) (Coverage, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Coverage{}, err
	}
	return typedFrom[Coverage](res), nil
}



func (e *CoverageEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CoverageEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CoverageEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CoverageEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CoverageEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
