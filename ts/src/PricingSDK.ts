...
class PricingSDK {
  ...
  CostGuide(data?: any) {
    const self = this
    return new CostGuideEntity(self,data)
  }
  ...
  Coverage(data?: any) {
    const self = this
    return new CoverageEntity(self,data)
  }
  ...
  Discover(data?: any) {
    const self = this
    return new DiscoverEntity(self,data)
  }
  ...
  Pricing(data?: any) {
    const self = this
    return new PricingEntity(self,data)
  }
  ...
  Tco(data?: any) {
    const self = this
    return new TcoEntity(self,data)
  }
