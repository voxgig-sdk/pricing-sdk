...
func registerSDKWords(r *eng.Registry, client *sdk.PricingSDK) {
...
func runOp(client *sdk.PricingSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
