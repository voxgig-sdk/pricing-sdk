...
local CoverageEntity = {}
CoverageEntity.__index = CoverageEntity


function CoverageEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CoverageEntity)
  self._name = "coverage"
  self._client = client
...
function CoverageEntity:get_name()
  return self._name
end


function CoverageEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CoverageEntity.new(self._client, opts)
end
...
function CoverageEntity:mark_deleted()
  self._deleted = true
end


function CoverageEntity:deleted()
  return true == self._deleted
end


function CoverageEntity:data_set(args)
  if args ~= nil then
...
function CoverageEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CoverageEntity:match_set(args)
  if args ~= nil then
...
function CoverageEntity:match_get()
...
function CoverageEntity:stream(action, args, callopts)
...
---@param reqmatch CoverageLoadMatch
---@param ctrl? table
---@return Coverage
---@return string? err
function CoverageEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function CoverageEntity:_run_op(ctx, post_done)
  local utility = self._utility
