...
class DiscoverEntity
  ...
  def make
    opts = @_entopts.dup
    DiscoverEntity.new(@_client, opts)
  end
  ...
  # @return [Discover, Hash] the current Discover data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Discover fields)
  def match_get
  ...
  #
  # @param reqmatch [DiscoverLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Discover.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Discover, Hash] the loaded Discover; raises PricingError on failure
