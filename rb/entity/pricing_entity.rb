...
class PricingEntity
  ...
  def make
    opts = @_entopts.dup
    PricingEntity.new(@_client, opts)
  end
  ...
  # @return [Pricing, Hash] the current Pricing data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Pricing fields)
  def match_get
  ...
  #
  # @param reqmatch [PricingLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Pricing.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Pricing, Hash] the loaded Pricing; raises PricingError on failure
