...
class PricingStreamingFeature extends PricingBaseFeature
{
    ...
    private function _iterate(PricingResult $result): \Generator
    {
    ...
    private function _streamable(PricingContext $ctx): bool
    {
