...
// Pricing SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class PricingTestFeature extends PricingBaseFeature
{
    ...
    public function init(PricingContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (PricingContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (PricingContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(PricingContext $ctx, $op, $args): array
    {
