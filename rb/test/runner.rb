...
module PricingTestRunner
  ...
  def self.env_override(m)
    live = getenv("PRICING_TEST_LIVE")
    override = getenv("PRICING_TEST_OVERRIDE")
    ...
    explain = getenv("PRICING_TEST_EXPLAIN")
    m["PRICING_TEST_EXPLAIN"] = explain if explain && !explain.empty?
