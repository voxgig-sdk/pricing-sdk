...
class PricingGraphql
{
    ...
    // equivalent.
    public static function body(PricingContext $ctx): mixed
    {
    ...
    public static function errors(PricingContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
