...
describe("HistoryDirect", function()
  it("should direct-load-history", function()
    local setup = history_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-history", setup.live and "live" or "unit")
