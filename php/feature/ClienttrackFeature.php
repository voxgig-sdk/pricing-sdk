...
// Pricing SDK clienttrack feature
...
class PricingClienttrackFeature extends PricingBaseFeature
{
    ...
    public function PostConstruct(PricingContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Pricing-SDK';
