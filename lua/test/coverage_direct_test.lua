...
describe("CoverageDirect", function()
  it("should direct-load-coverage", function()
    local setup = coverage_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-coverage", setup.live and "live" or "unit")
...
function coverage_direct_setup(mockres)
