...
func NewPricingEntity(client *core.PricingSDK, entopts map[string]any) *PricingEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PricingEntity) GetName() string { return e.name }
...
func (e *PricingEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PricingEntity) Deleted() bool {
	return e.deleted
}


func (e *PricingEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPricingEntity(e.client, opts)
}

func (e *PricingEntity) Data(args ...any) any {
...
func (e *PricingEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Pricing; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PricingEntity) DataTyped(data ...Pricing) Pricing {
	if len(data) > 0 {
		return typedFrom[Pricing](e.Data(asMap(data[0])))
	}
	return typedFrom[Pricing](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Pricing (all fields
// optional at the wire level).
func (e *PricingEntity) MatchTyped(match ...Pricing) Pricing {
	if len(match) > 0 {
		return typedFrom[Pricing](e.Match(asMap(match[0])))
	}
	return typedFrom[Pricing](e.Match())
}
...
func (e *PricingEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PricingEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PricingLoadMatch and returns an Pricing. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PricingEntity) LoadTyped(reqmatch PricingLoadMatch, ctrl map[string]any) (Pricing, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Pricing{}, err
	}
	return typedFrom[Pricing](res), nil
}



func (e *PricingEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *PricingEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PricingEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PricingEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PricingEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
