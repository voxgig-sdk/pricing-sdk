...
The PHP SDK for the Pricing API — an entity-oriented client using PHP conventions.
...
```
php/
├── pricing_sdk.php          -- Main SDK class
...
The main class (`pricing_sdk.php`) exports the SDK class
