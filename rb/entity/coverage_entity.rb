...
class CoverageEntity
  ...
  def make
    opts = @_entopts.dup
    CoverageEntity.new(@_client, opts)
  end
  ...
  # @return [Coverage, Hash] the current Coverage data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Coverage fields)
  def match_get
  ...
  #
  # @param reqmatch [CoverageLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Coverage.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Coverage, Hash] the loaded Coverage; raises PricingError on failure
