...
class DiscoverEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DiscoverEntity($this->_client, $opts);
    }

    /**
     * @param Discover|array $args Discover data (assoc-array) to store.
     */
    ...
    /**
     * @return Discover|array The current Discover data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Discover fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Discover fields).
     */
    ...
    /**
     * Load a single Discover.
     *
     * @param DiscoverLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DiscoverLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Discover|array The loaded Discover as an assoc-array at the
