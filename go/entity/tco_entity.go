...
func NewTcoEntity(client *core.PricingSDK, entopts map[string]any) *TcoEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TcoEntity) GetName() string { return e.name }
...
func (e *TcoEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TcoEntity) Deleted() bool {
	return e.deleted
}


func (e *TcoEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTcoEntity(e.client, opts)
}

func (e *TcoEntity) Data(args ...any) any {
...
func (e *TcoEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Tco; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TcoEntity) DataTyped(data ...Tco) Tco {
	if len(data) > 0 {
		return typedFrom[Tco](e.Data(asMap(data[0])))
	}
	return typedFrom[Tco](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Tco (all fields
// optional at the wire level).
func (e *TcoEntity) MatchTyped(match ...Tco) Tco {
	if len(match) > 0 {
		return typedFrom[Tco](e.Match(asMap(match[0])))
	}
	return typedFrom[Tco](e.Match())
}
...
func (e *TcoEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TcoEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *TcoEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *TcoEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TcoCreateData and returns an Tco. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *TcoEntity) CreateTyped(reqdata TcoCreateData, ctrl map[string]any) (Tco, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Tco{}, err
	}
	return typedFrom[Tco](res), nil
}



func (e *TcoEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TcoEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TcoEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
