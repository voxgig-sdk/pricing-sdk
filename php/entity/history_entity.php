...
class HistoryEntity
{
    ...
    /**
     * Load a single History.
     *
     * @param HistoryLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed HistoryLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return History|array The loaded History as an assoc-array at the
