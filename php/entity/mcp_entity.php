...
class McpEntity
{
     ...
     * Create a new Mcp.
     *
     * @param McpCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed McpCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Mcp|array The created Mcp as an assoc-array at the
