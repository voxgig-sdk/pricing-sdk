...
(0, node_test_1.describe)('TcoEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'tco.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != tco_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/tco/TcoTestData.json');
    ...
    let idmap = transform(['tco01', 'tco02', 'tco03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['PRICING_TEST_TCO_ENTID'];
...
//# sourceMappingURL=TcoEntity.test.js.map