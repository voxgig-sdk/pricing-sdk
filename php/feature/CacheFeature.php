...
class PricingCacheFeature extends PricingBaseFeature
{
    ...
    private function _through(PricingContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
