...
from pricing_sdk.core.response import PricingResponse
from pricing_sdk.core.operation import PricingOperation
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = PricingSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = PricingSDK.test(None, None)
        ...
        class TestInitFeature(PricingBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(PricingBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = PricingSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = PricingSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = PricingSDK.test(None, setup_opts)
