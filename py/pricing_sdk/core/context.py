...
from pricing_sdk.core.helpers import get_ctx_prop, to_map
...
class PricingContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, PricingResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return PricingError(code, msg, self)
