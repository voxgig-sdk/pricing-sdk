...
func NewHistoryEntity(client *core.PricingSDK, entopts map[string]any) *HistoryEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *HistoryEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// HistoryLoadMatch and returns an History. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *HistoryEntity) LoadTyped(reqmatch HistoryLoadMatch, ctrl map[string]any) (History, error) {
