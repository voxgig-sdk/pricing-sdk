...
describe("CompareDirect", function()
  it("should direct-load-compare", function()
    local setup = compare_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-compare", setup.live and "live" or "unit")
