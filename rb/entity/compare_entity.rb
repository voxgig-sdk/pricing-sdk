...
class CompareEntity
  ...
  #
  # @param reqmatch [CompareLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Compare.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Compare, Hash] the loaded Compare; raises PricingError on failure
