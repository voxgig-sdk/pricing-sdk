...
func NewDiscoverEntity(client *core.PricingSDK, entopts map[string]any) *DiscoverEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DiscoverEntity) GetName() string { return e.name }
...
func (e *DiscoverEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DiscoverEntity) Deleted() bool {
	return e.deleted
}


func (e *DiscoverEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDiscoverEntity(e.client, opts)
}

func (e *DiscoverEntity) Data(args ...any) any {
...
func (e *DiscoverEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Discover; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DiscoverEntity) DataTyped(data ...Discover) Discover {
	if len(data) > 0 {
		return typedFrom[Discover](e.Data(asMap(data[0])))
	}
	return typedFrom[Discover](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Discover (all fields
// optional at the wire level).
func (e *DiscoverEntity) MatchTyped(match ...Discover) Discover {
	if len(match) > 0 {
		return typedFrom[Discover](e.Match(asMap(match[0])))
	}
	return typedFrom[Discover](e.Match())
}
...
func (e *DiscoverEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DiscoverEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DiscoverLoadMatch and returns an Discover. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *DiscoverEntity) LoadTyped(reqmatch DiscoverLoadMatch, ctrl map[string]any) (Discover, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Discover{}, err
	}
	return typedFrom[Discover](res), nil
}



func (e *DiscoverEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *DiscoverEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DiscoverEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DiscoverEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DiscoverEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
