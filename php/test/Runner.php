...
class PricingTestRunner
{
    ...
    {
        $live = self::getenv('PRICING_TEST_LIVE');
        $override = self::getenv('PRICING_TEST_OVERRIDE');
        ...
        $explain = self::getenv('PRICING_TEST_EXPLAIN');
...
class_alias('PricingTestRunner', 'Runner');
class_alias('PricingHelpers', 'Helpers');
