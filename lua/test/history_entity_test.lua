...
describe("HistoryEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set PRICING_TEST_HISTORY_ENTID JSON to run live")
      return
    end
...
function history_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("PRICING_TEST_HISTORY_ENTID")
