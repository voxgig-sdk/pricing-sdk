...
from pricing_sdk.utility import register

# Load features
from pricing_sdk.feature.base_feature import PricingBaseFeature
from pricing_sdk.features import _has_feature, _make_feature
...
class PricingSDK:
    ...
    def __init__(self, options=None):
        ...
        from pricing_sdk.config import shared_config
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("PricingSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Compare(self, data=None) -> "CompareEntity":
        ...
        from pricing_sdk.entity.compare_entity import CompareEntity
    ...
    def CostGuide(self, data=None) -> "CostGuideEntity":
        ...
        from pricing_sdk.entity.cost_guide_entity import CostGuideEntity
    ...
    def Coverage(self, data=None) -> "CoverageEntity":
        ...
        from pricing_sdk.entity.coverage_entity import CoverageEntity
    ...
    def Discover(self, data=None) -> "DiscoverEntity":
        ...
        from pricing_sdk.entity.discover_entity import DiscoverEntity
