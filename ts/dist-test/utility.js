...
function envOverride(m) {
    if ('TRUE' === process.env.PRICING_TEST_LIVE ||
        'TRUE' === process.env.PRICING_TEST_OVERRIDE) {
    ...
    m.PRICING_TEST_EXPLAIN = process.env.PRICING_TEST_EXPLAIN || m.PRICING_TEST_EXPLAIN;
    return m;
}
