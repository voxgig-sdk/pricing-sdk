...
type CostGuideEntity struct {
	name    string
	client  *core.PricingSDK
...
func NewCostGuideEntity(client *core.PricingSDK, entopts map[string]any) *CostGuideEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CostGuideEntity) GetName() string { return e.name }
...
func (e *CostGuideEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CostGuideEntity) Deleted() bool {
	return e.deleted
}


func (e *CostGuideEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCostGuideEntity(e.client, opts)
}

func (e *CostGuideEntity) Data(args ...any) any {
...
func (e *CostGuideEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CostGuide; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CostGuideEntity) DataTyped(data ...CostGuide) CostGuide {
	if len(data) > 0 {
		return typedFrom[CostGuide](e.Data(asMap(data[0])))
	}
	return typedFrom[CostGuide](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CostGuide (all fields
// optional at the wire level).
func (e *CostGuideEntity) MatchTyped(match ...CostGuide) CostGuide {
	if len(match) > 0 {
		return typedFrom[CostGuide](e.Match(asMap(match[0])))
	}
	return typedFrom[CostGuide](e.Match())
}
...
func (e *CostGuideEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CostGuideEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CostGuideLoadMatch and returns an CostGuide. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CostGuideEntity) LoadTyped(reqmatch CostGuideLoadMatch, ctrl map[string]any) (CostGuide, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return CostGuide{}, err
	}
	return typedFrom[CostGuide](res), nil
}



func (e *CostGuideEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CostGuideEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CostGuideEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CostGuideEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CostGuideEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
