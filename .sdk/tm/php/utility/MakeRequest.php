...
// Pricing SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class PricingMakeRequest
{
    public static function call(PricingContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new PricingResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new PricingResponse($fetched);
        } else {
