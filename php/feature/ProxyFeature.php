...
class PricingProxyFeature extends PricingBaseFeature
{
    ...
    public function init(PricingContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (PricingContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
