...
class PricingTimeoutFeature extends PricingBaseFeature
{
    ...
    private function _with_timeout(PricingContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(PricingContext $_ctx, float $ms): void
    {
        $client = $this->client;
