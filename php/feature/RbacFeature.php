...
class PricingRbacFeature extends PricingBaseFeature
{
    ...
    private function _required(PricingContext $ctx): ?string
    {
    ...
    private function _reject(PricingContext $ctx, string $required): void
    {
    ...
    private function _track(PricingContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
