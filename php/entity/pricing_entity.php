...
class PricingEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PricingEntity($this->_client, $opts);
    }

    /**
     * @param Pricing|array $args Pricing data (assoc-array) to store.
     */
    ...
    /**
     * @return Pricing|array The current Pricing data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Pricing fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Pricing fields).
     */
    ...
    /**
     * Load a single Pricing.
     *
     * @param PricingLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PricingLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Pricing|array The loaded Pricing as an assoc-array at the
