...
describe("CostGuideDirect", function()
  it("should direct-load-cost_guide", function()
    local setup = cost_guide_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-cost_guide", setup.live and "live" or "unit")
...
function cost_guide_direct_setup(mockres)
