...
class CoverageEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CoverageEntity($this->_client, $opts);
    }

    /**
     * @param Coverage|array $args Coverage data (assoc-array) to store.
     */
    ...
    /**
     * @return Coverage|array The current Coverage data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Coverage fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Coverage fields).
     */
    ...
    /**
     * Load a single Coverage.
     *
     * @param CoverageLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CoverageLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Coverage|array The loaded Coverage as an assoc-array at the
