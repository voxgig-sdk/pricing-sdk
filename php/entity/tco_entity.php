...
class TcoEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TcoEntity($this->_client, $opts);
    }

    /**
     * @param Tco|array $args Tco data (assoc-array) to store.
     */
    ...
    /**
     * @return Tco|array The current Tco data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Tco fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Tco fields).
     */
     ...
     * Create a new Tco.
     *
     * @param TcoCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed TcoCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Tco|array The created Tco as an assoc-array at the
