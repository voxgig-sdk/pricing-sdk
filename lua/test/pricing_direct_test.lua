...
describe("PricingDirect", function()
  it("should direct-load-pricing", function()
    local setup = pricing_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-pricing", setup.live and "live" or "unit")
...
function pricing_direct_setup(mockres)
