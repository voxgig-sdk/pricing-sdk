...
class HistoryEntity
  ...
  #
  # @param reqmatch [HistoryLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.History.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [History, Hash] the loaded History; raises PricingError on failure
