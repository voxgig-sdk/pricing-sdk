...
class CompareEntity
{
    ...
    /**
     * Load a single Compare.
     *
     * @param CompareLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CompareLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Compare|array The loaded Compare as an assoc-array at the
