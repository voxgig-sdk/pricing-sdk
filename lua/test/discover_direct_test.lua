...
describe("DiscoverDirect", function()
  it("should direct-load-discover", function()
    local setup = discover_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-discover", setup.live and "live" or "unit")
...
function discover_direct_setup(mockres)
