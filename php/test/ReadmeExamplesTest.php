...
// Pricing SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (PricingSDK::test)
...
{
    private const SDK_CLASS = 'PricingSDK';
    ...
    private const SDK_BASE = 'pricing_sdk';
