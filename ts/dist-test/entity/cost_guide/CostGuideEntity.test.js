...
(0, node_test_1.describe)('CostGuideEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'cost_guide.' + op, live))
                return;
        }
        ...
        let cost_guide_ref01_data = Object.values(setup.data.existing.cost_guide)[0];
        // LOAD
        const cost_guide_ref01_ent = client.CostGuide();
        const cost_guide_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(cost_guide_ref01_data_dt0.id === cost_guide_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/cost_guide/CostGuideTestData.json');
    ...
    let idmap = transform(['cost_guide01', 'cost_guide02', 'cost_guide03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['PRICING_TEST_COST_GUIDE_ENTID'];
...
//# sourceMappingURL=CostGuideEntity.test.js.map