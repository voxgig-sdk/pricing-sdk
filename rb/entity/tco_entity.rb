...
class TcoEntity
  ...
  # @return [Tco, Hash] the current Tco data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Tco fields)
  def match_get
  ...
  # Create a new Tco.
  #
  # @param reqdata [TcoCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Tco, Hash] the created Tco; raises PricingError on failure
