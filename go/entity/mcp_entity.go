...
func NewMcpEntity(client *core.PricingSDK, entopts map[string]any) *McpEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *McpEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *McpEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// McpCreateData and returns an Mcp. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *McpEntity) CreateTyped(reqdata McpCreateData, ctrl map[string]any) (Mcp, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Mcp{}, err
	}
	return typedFrom[Mcp](res), nil
}
