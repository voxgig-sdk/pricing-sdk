...
class PricingNetsimFeature extends PricingBaseFeature
{
    ...
    private function _simulate(PricingContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(PricingContext $ctx, array $applied): void
    {
        $client = $this->client;
