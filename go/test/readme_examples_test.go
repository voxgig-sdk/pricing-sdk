...
const testSeed = `map[string]any{"entity": map[string]any{"compare": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "cost_guide": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "coverage": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "discover": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "history": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "mcp": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "pricing": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "tco": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "usage": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
