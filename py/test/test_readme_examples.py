# Pricing SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions PricingSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both PricingSDK(...) and PricingSDK.test(...) become
#      PricingSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "pricing_sdk"
_SDK_CLASS = "PricingSDK"
