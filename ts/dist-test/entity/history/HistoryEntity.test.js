...
(0, node_test_1.describe)('HistoryEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(history_ref01_data_dt0.id === history_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['PRICING_TEST_HISTORY_ENTID'];
