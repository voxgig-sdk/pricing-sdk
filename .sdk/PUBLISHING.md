...
|---|---|---|
| `ts/` | @voxgig-sdk/pricing-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/pricing-sdk \
      --repository voxgig-sdk/pricing-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/pricing-sdk` shows it, and
`npm trust revoke @voxgig-sdk/pricing-sdk --id=<id>` removes it.
