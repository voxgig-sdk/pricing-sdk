...
The Python SDK for the Pricing API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Compare()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/pricing-sdk/releases)) or
...
```
py/
├── pricing_sdk.py         -- Main SDK module
